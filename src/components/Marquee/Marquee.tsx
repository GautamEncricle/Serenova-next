          ...
          <div className="content">
            <ul className="gap-[20px] min-640:gap-[30px] min-990:gap-[50px] min-1400:gap-[100px]">
              {marqueeData.map((item: { label: string }, index: number) => (
                <li key={index}>
                  <p
                    className="font-[250] text-[40px] min-640:text-[50px] min-990:text-[80px] min-1400:text-[150px] min-1600:text-[200px] leading-150p text-primary-900 !font-[250]"
                    style={{ fontWeight: "250 !importance" }}>
                    {item.label}
                  </p>
                </li>
              ))}
